...
document.getElementById("wtd").innerHTML="Please Draw "+sketch
function setup() {
...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("guess").innerHTML = "Your sketch is a- " + drawn_sketch;
        document.getElementById("conf").innerHTML = "Im this much confident- "+
